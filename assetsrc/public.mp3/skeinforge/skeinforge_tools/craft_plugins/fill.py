...
# zip
# getDirectory in fabmetheus, fabmetheus_utiltiles
# skeinforge_plugins
# squirrel, addObject, getTarget, setMatrix
# alterGeometry
# getDirectoryFromFileName
# booleangeometry_tools, carvable_tools + polygon & code -> tools + code_plugins
# position xyz mxx.., read, creationID
# translate, extrude, rotation, lathe, tube, array, parent.attribute, id.id name.attribute
...
class FillRepository:
	...
	def __init__( self ):
		...
		skeinforge_profile.addListsToCraftTypeRepository( 'skeinforge.skeinforge_tools.craft_plugins.fill.html', self )
