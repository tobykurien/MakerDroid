...
from skeinforge.skeinforge_tools.analyze_plugins.analyze_utilities import zoom_in
from skeinforge.skeinforge_tools.analyze_plugins.analyze_utilities import zoom_out
...
class TableauWindow:
	...
	def addCanvasMenuRootScrollSkein( self, repository, skein, suffix, title ):
		...
		self.imagesDirectoryPath = settings.getDirectoryInAboveDirectory( os.path.join( 'fabmetheus_utilities', 'images' ) )
