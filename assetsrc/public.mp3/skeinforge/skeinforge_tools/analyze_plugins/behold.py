...
from skeinforge.skeinforge_tools.analyze_plugins.analyze_utilities import view_rotate
...
class BeholdRepository( tableau.TableauRepository ):
	...
	def __init__( self ):
		...
		settings.addListsToRepository( 'skeinforge.skeinforge_tools.analyze_plugins.behold.html', '', self )
